<ul>
  ...
  <li>
    ...
    <span rel="menu-container-minimize-all" role="toaster-content">
        Minimiza todas as janelas, mostrando o desktop. Janelas <i>pinned</i> não são afectadas.
    </span>
  </li>
  ...
  <li>
    ...
    <span rel="menu-container-cascade" role="toaster-content">
        Dispõe todas as janelas em cascata
    </span>
  </li>
  ...
  <li>
    ...
    <span rel="menu-container-tile" role="toaster-content">
        Redimensiona e alinha todas as janelas no ecrã.
    </span>
  </li>

  <li class="separator">
    <a id="menu-close-all" href="#" role="toaster-launcher">
      <i class="fa fa-times"></i> Fechar Tudo
    </a>
    <span rel="menu-close-all" role="toaster-content">
        Fecha todas as janelas abertas pelo utilizador, excepto as janelas <i>pinned</i> ao Desktop.
    </span>
  </li>
