...
App.Desktop = (function() {
    ...
    Desktop.changeDomWithoutReloadForLogin = function() {
        ...
        (function() {
            ...
            $("div#widget-user-menu ul:first li:first").find("i").css("background-image", "url('//minotar.minecraft.pt/avatar/" + App.session.username + "/16')");
            $("div#widget-user-menu ul:first li:first").contents().last().replaceWith(App.session.username);
        })();
    ...
    Desktop.changeDomWithoutReloadForLogout = function() {
        ...
        (function() {
            ...
            $("div#widget-user-menu ul:first li:first").find("i").css("background-image", "");
            $("div#widget-user-menu ul:first li:first").contents().last().replaceWith("");
        })();
    };
